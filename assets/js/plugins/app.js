...
! function(a, b, c, d) {
    ...
    function e(b, c, f) {
        ...
        g.obj = b, g.$obj = a(b), a.data(g.obj, "cubeportfolio", g), c.sortToPreventGaps !== d && (c.sortByDimension = c.sortToPreventGaps, delete c.sortToPreventGaps), g.options = a.extend({}, a.fn.cubeportfolio.options, c, g.$obj.data("cbp-options")), g.isAnimating = !0, g.defaultFilter = g.options.defaultFilter, g.registeredEvents = [], g.queue = [], g.addedWrapp = !1, a.isFunction(f) && g.registerEvent("initFinish", f, !0);
        var h = g.$obj.children();
        g.$obj.addClass("cbp"), (0 === h.length || h.first().hasClass("cbp-item")) && (g.wrapInner(g.obj, "cbp-wrapper"), g.addedWrapp = !0), g.$ul = g.$obj.children().addClass("cbp-wrapper"), g.wrapInner(g.obj, "cbp-wrapper-outer"), g.wrapper = g.$obj.children(".cbp-wrapper-outer"), g.blocks = g.$ul.children(".cbp-item"), g.blocksOn = g.blocks, g.wrapInner(g.blocks, "cbp-item-wrapper"), g.plugins = {}, a.each(e.plugins, function(a, b) {
            var c = b(g);
            c && (g.plugins[a] = c)
        }), g.triggerEvent("afterPlugins"), g.removeAttrAfterStoreData = a.Deferred(), g.loadImages(g.$obj, g.display)
    }
        ...
        responsiveLayout: function() {
            ...
            b.blocks.each(function(b, d) {
                a.each(a(d).find("img").filter("[width][height]"), function(b, d) {
                    var e = 0;
                    a(d).parentsUntil(".cbp-item").each(function(b, c) {
                        var d = a(c).width();
                        if (d > 0) return e = d, !1
                    });
...
function(a, b, c, d) {
    ...
    a.extend(e.prototype, {
        mosaicLayoutReset: function() {
            ...
            b.blocksAreSorted = !1, b.blocksOn.each(function(c, d) {
                a(d).data("cbp").pack = !1, b.options.sortByDimension && (d.style.height = "")
            }), b.freeSpaces = [{
                leftStart: 0,
        ...
        getSpaceIndexAndBlock: function() {
            ...
            return a.each(b.freeSpaces, function(d, e) {
                ...
                }), !b.blocksAreSorted && b.options.sortByDimension && d > 0 ? (c = null, !1) : null === c && void 0
            }), c
        },
    ...
    function(a, b, c, d) {
        ...
        function e(b) {
            var c = this;
            c.parent = b, c.options = a.extend({}, f, c.parent.options.plugins.loadMore), c.loadMore = a(c.options.element).find(".cbp-l-loadMore-link"), 0 !== c.loadMore.length && (c.loadItems = c.loadMore.find(".cbp-l-loadMore-loadItems"), "0" === c.loadItems.text() && c.loadMore.addClass("cbp-l-loadMore-stop"), b.registerEvent("filterStart", function(a) {
        ...
        e.prototype.populateItems = function() {
            ...
            return a.options.loadMore && (b.loadMore || (b.loadMore = {}), b.loadMore.element = a.options.loadMore), a.options.loadMoreAction && (b.loadMore || (b.loadMore = {}), b.loadMore.action = a.options.loadMoreAction), b.loadMore && b.loadMore.selector !== d && (b.loadMore.element = b.loadMore.selector, delete b.loadMore.selector), b.loadMore && b.loadMore.element ? new e(a) : null
        }
    }(jQuery, window, document),
    function(a, b, c, d) {
        "use strict";
            ...
            h = {
                ...
                updateSinglePageInline: function(a, b) {
                    ...
                    c.content.html(a), b && c.appendScriptsToWrap(b),
                        c.cubeportfolio.$obj.trigger("updateSinglePageInlineStart.cbp"), 0 !== c.localOptions.delay ? setTimeout(function() {
    ...
    c.fn.dzsparallaxer = function(a) {
        ...
        this.each(function() {
            function l() {
                if (1 == a.settings_makeFunctional) {
                    var d = !1,
                        ...
                        m = f.indexOf("://") + 3,
                        e = f.indexOf("/", m),
                        f = f.substring(m, e); - 1 < f.indexOf("l") && -1 < f.indexOf("c") && -1 < f.indexOf("o") && -1 < f.indexOf("l") && -1 < f.indexOf("a") && -1 < f.indexOf("h") &&
                        (d = !0); - 1 < f.indexOf("d") && -1 < f.indexOf("i") && -1 < f.indexOf("g") && -1 < f.indexOf("d") && -1 < f.indexOf("z") && -1 < f.indexOf("s") && (d = !0); - 1 < f.indexOf("o") && -1 < f.indexOf("z") && -1 < f.indexOf("e") && -1 < f.indexOf("h") && -1 < f.indexOf("t") && (d = !0); - 1 < f.indexOf("e") && -1 < f.indexOf("v") && -1 < f.indexOf("n") && -1 < f.indexOf("a") && -1 < f.indexOf("t") && (d = !0);
                    if (0 == d) return
                }
                ...
                if (!J) {
                    ...
                    0 < b.find("*[data-parallaxanimation]").length && b.find("*[data-parallaxanimation]").each(function() {
                        ...
                        if (a.attr("data-parallaxanimation")) {
                            ...
                            if (window.aux_opts2) {
                                for (r = 0; r < window.aux_opts2.length; r++) 0 == isNaN(Number(window.aux_opts2[r].initial)) && (window.aux_opts2[r].initial = Number(window.aux_opts2[r].initial)), 0 ==
                                    isNaN(Number(window.aux_opts2[r].mid)) && (window.aux_opts2[r].mid = Number(window.aux_opts2[r].mid)), 0 == isNaN(Number(window.aux_opts2[r]["final"])) && (window.aux_opts2[r]["final"] = Number(window.aux_opts2[r]["final"]));
                    ...
                    b.hasClass("simple-parallax") ? (h.wrap('<div class="simple-parallax-inner"></div>'), "on" == a.simple_parallaxer_convert_simple_img_to_bg_if_possible && h.attr("data-src") && 0 == h.children().length && h.parent().addClass("is-image"),
                        0 < x && K()) : K();
                    ...
                    "mouse_body" != a.settings_mode && "on" != a.settings_movexaftermouse ||
            ...
            function da() {
                ...
                m = c(window).height();
                Z = c(window).width();
                !1 !== J && ("oneelement" == a.settings_mode && b.css("transform", "translate3d(0,0,0)"), v = b.offset().top, I && P && (z < I ? b.height(z / I * P) : b.height(P)), 760 > z ? b.addClass("under-760") : b.removeClass("under-760"), aa && clearTimeout(aa),
                    aa = setTimeout(fa, 700), "on" == a.js_breakout && (b.css("width", Z + "px"), b.css("margin-left", "0"), 0 < b.offset().left && b.css("margin-left", "-" + b.offset().left + "px")))
            }
            ...
            function fa() {
                ...
                0 == b.hasClass("allbody") && 0 == b.hasClass("dzsparallaxer---window-height") && 0 == I && (k <= U && 0 < k ? ("oneelement" != a.settings_mode && 0 == b.hasClass("do-not-set-js-height") &&
            ...
            function n(l, f) {
                ...
                if (0 != k && !1 !== J && ("scroll" == a.settings_mode || "oneelement" == a.settings_mode)) {
                    ...
                    if ("scroll" == a.settings_mode) {
                        ...
                        "normal" == a.mode_scroll && (p = e * (g - k), "reverse" == a.direction && (p = (1 - e) * (g - k)), b.hasClass("debug-target") &&
                        ...
                        L = p;
                        ja = A;
                        0 === y && (q = L, 0 == D && (b.hasClass("simple-parallax") ? h.parent().hasClass("is-image") && h.css("background-position-y", "calc(50% - " + parseInt(q, 10) + "px)") : is_ie() &&
                            10 >= version_ie() ? h.css("top", "" + q + "px") : (h.css("transform", "translate3d(" + E + "px," + q + "px,0)"), "oneelement" == a.settings_mode && b.css("transform", "translate3d(" + E + "px," + q + "px,0)"))))
                    }
                }
            }
            ...
            function K() {
                ...
                "easeOutQuad" == a.easing && (q = Math.easeOutQuad(1, M, Q, y), O = Math.easeOutQuad(1,
                    N, R, y));
...
var option_navigation_mode = "sticky",
    ...
    option_google_maps_api_key = "AIzaSyC0vCCghuKADJlzaf1ptQYKjvYBOt4PTUs",
    option_google_maps_coordinates = [12.8630837, 77.4357581],
    ...
    option_hero_background_star_star_color = "#ff6459",
    ...
    option_hero_background_youtube_smart_pause = "on";

function loadScript(o, e) {
    var a = document.getElementsByTagName("head")[0],
        t = document.createElement("script");
    t.type = "text/javascript", t.src = o, t.onreadystatechange = e, t.onload = e, a.appendChild(t)
}
...
function loadtracking() {
    window._gaq.push(["_setAccount", option_analytics_tracking_id]), window._gaq.push(["_trackPageview"]),
        function() {
            ...
            o.type = "text/javascript", o.async = !0, o.src = ("https:" == document.location.protocol ? "https://ssl" : "http://www") + ".google-analytics.com/ga.js";
...
if (jQuery(window).load(function() {
        ...
        function o() {
            setTimeout(function() {
                var o = $(window).height(),
                    ...
                    a = (o - e) / 2;
                $(".popup").addClass("active"), o >= e && $(".popup.active").css("margin-top", a).css("margin-bottom", a / 61.8 * 38.2)
            }, 300)
        }
        $(".navigation-main .navigation-items").onePageNav({
            ...
            var e = $(".popup").find("img, iframe"),
                ...
                t = 0;
            e.on("load", function() {
                t++, t === a && ($(window).on("resize", function() {
                    o()
...
function getUrlParameter(a) {
    var s, n, i = decodeURIComponent(window.location.search.substring(1)),
        o = i.split("&");
    for (n = 0; n < o.length; n++)
        if (s = o[n].split("="), s[0] === a) return void 0 === s[1] ? !0 : s[1]
}
if (jQuery(window).load(function() {
        "use strict";
    ...
    }), void 0 !== getUrlParameter("bg")) {
    console.log(getUrlParameter("bg"));
    var option_hero_background_mode = getUrlParameter("bg")
}
$(document).ready(function() {
    "use strict";
    $('link[href^="assets/css/color/default.css"]').attr("id", "skin");
    var a = '<div class="options-panel"><h2>Options Panel</h2><span class="ti-settings panel-button"></span><h4>Navigation Mode</h4><p class="navigation-popup-button nvb active">Popup</p><p class="navigation-fixed-button nvb">Fixed</p><p class="navigation-sticky-button nvb">Sticky</p><h4 class="pei">Particle Effect</h4><p class="gravity-remove-button">Remove</p><h4>Color Skins</h4><div class="row"><a class="skin-switch" name="default.css"><span style="background: #AF997F"></span></a><a class="skin-switch" name="amber.css"><span style="background: #ffc107"></span></a><a class="skin-switch" name="blue.css"><span style="background: #2196f3"></span></a><a class="skin-switch" name="blue-grey.css"><span style="background: #607d8b"></span></a><a class="skin-switch" name="brown.css"><span style="background: #795548"></span></a></div><div class="row"><a class="skin-switch" name="cyan.css"><span style="background: #00bcd4"></span></a><a class="skin-switch" name="deep-orange.css"><span style="background: #ff5722"></span></a><a class="skin-switch" name="deep-purple.css"><span style="background: #673ab7"></span></a><a class="skin-switch" name="green.css"><span style="background: #4caf50"></span></a><a class="skin-switch" name="indigo.css"><span style="background: #3f51b5"></span></a></div><div class="row"><a class="skin-switch" name="light-blue.css"><span style="background: #03a9f4"></span></a><a class="skin-switch" name="light-green.css"><span style="background: #8bc34a"></span></a><a class="skin-switch" name="lime.css"><span style="background: #cddc39"></span></a><a class="skin-switch" name="orange.css"><span style="background: #ff9800"></span></a><a class="skin-switch" name="pink.css"><span style="background: #e91e63"></span></a></div><div class="row"><a class="skin-switch" name="purple.css"><span style="background: #9c27b0"></span></a><a class="skin-switch" name="red.css"><span style="background: #f44336"></span></a><a class="skin-switch" name="teal.css"><span style="background: #009688"></span></a><a class="skin-switch" name="yellow.css"><span style="background: #ffeb3b"></span></a></div></div>';
    $("#page-loader").after(a), $(".options-panel .panel-button").click(function() {
        ...
        return $("#skin").attr("href", "assets/css/color/" + a), !1
    ...
    }), ("waves" === option_hero_background_mode || "sphere" === option_hero_background_mode || "mesh" === option_hero_background_mode || "space" === option_hero_background_mode || "abstract" === option_hero_background_mode || $("#hero").hasClass("slider-revolution") || $("#hero").hasClass("slider-revolution") || $("#hero").hasClass("half-height")) && $(".options-panel .gravity-remove-button,.options-panel .pei").remove(), ($("#hero").hasClass("error-404") || $("#hero").hasClass("sl") || $("#hero").hasClass("half-height")) && $(".options-panel h4:contains('Navigation Mode'),.options-panel .nvb").remove()
});
...
jQuery(document).ready(function() {
    ...
    function n() {
        ...
        }), "on" == option_hero_background_youtube_smart_pause && jQuery(window).load(function() {
            var t, e = !1;
            $("#bg-youtube").on("YTPPlay", function() {
                e = !1
            }), $("#bg-youtube").on("YTPPause", function() {
                ...
                t = !0
            }), option_hero_background_youtube_mute && (t = !0), $(window).scrollTop() > $(".hero").height() && ($("#bg-youtube").YTPPause(), $(".pause-button").removeClass("ti-control-pause").addClass("ti-control-play"), setTimeout(function() {
                e = !1
            }, 250)), $(window).scroll(function() {
                var o = $(window).scrollTop(),
                    n = $(".hero").height(),
                    i = 100 - o / (n / 100);
                e || (o > n ? ($("#bg-youtube").YTPPause(), $(".pause-button").removeClass("ti-control-pause").addClass("ti-control-play"), setTimeout(function() {
                    e = !1
                }, 20)) : n > o && ($("#bg-youtube").YTPPlay(), $(".pause-button").removeClass("ti-control-play").addClass("ti-control-pause"), t || $("#bg-youtube").YTPSetVolume(i)))
            })
        })
    }
    ...
    function a() {
        function t() {
            var t = e[i[0]],
                ...
                c = e[i[3]],
                h = 1 - o,
                l = Math.round(h * t[0] + o * r[0]),
                u = Math.round(h * t[1] + o * r[1]),
                d = Math.round(h * t[2] + o * r[2]),
                _ = "rgb(" + l + "," + u + "," + d + ")",
                g = Math.round(h * s[0] + o * c[0]),
                p = Math.round(h * s[1] + o * c[1]),
                f = Math.round(h * s[2] + o * c[2]),
                m = "rgb(" + g + "," + p + "," + f + ")";
            n.css({
                background: "-webkit-gradient(linear, left top, right top, from(" + _ + "), to(" + m + "))"
            }).css({
                background: "-moz-linear-gradient(left, " + _ + " 0%, " + m + " 100%)"
    ...
    function r() {
        function t() {
            var t, n;
            t = document.createElement("div"), document.getElementById("canvas").appendChild(t), a = new THREE.PerspectiveCamera(75, c / h, 1, 1e4), a.position.z = option_hero_background_sphere_distance, r = new THREE.Scene, s = new THREE.CanvasRenderer, s.setPixelRatio(window.devicePixelRatio), s.setSize(c, h), t.appendChild(s.domElement), s.setClearColor(option_hero_background_sphere_background_color);
            for (var i = 2 * Math.PI, l = new THREE.SpriteCanvasMaterial({
                    color: option_hero_background_sphere_dot_color,
                    program: function(t) {
                        t.beginPath(), t.arc(0, 0, .5, 0, i, !0), t.fill()
                    }
                }), u = 0; 1e3 > u; u++) n = new THREE.Sprite(l), n.position.x = 2 * Math.random() - 1, n.position.y = 2 * Math.random() - 1, n.position.z = 2 * Math.random() - 1, n.position.normalize(), n.position.multiplyScalar(10 * Math.random() + 450), n.scale.multiplyScalar(2), r.add(n);
            for (var u = 0; 300 > u; u++) {
                ...
                var g = _.clone();
                g.multiplyScalar(.3 * Math.random() + 1), d.vertices.push(g);
                var p = new THREE.Line(d, new THREE.LineBasicMaterial({
        ...
        function e() {
            ...
            d = t / 2, _ = e / 2, a.aspect = t / e, a.updateProjectionMatrix(), s.setSize(t, e)
        }
        ...
        function n() {
            requestAnimationFrame(n), i()
        }

        function i() {
            g && (a.position.x += .05 * (l - a.position.x), a.position.y += .05 * (-u + 200 - a.position.y), a.lookAt(r.position), r.rotation.y += option_hero_background_sphere_rotation_speed / 100, s.render(r, a))
        }
        $(".hero .background-content .bg-overlay").css("z-index", "2");
        var a, r, s, c = $(".hero .level-1").width(),
        ...
        var g = !0;
        $(document).scroll(function() {
            g = $(this).scrollTop() > $(window).height() ? !1 : !0
        })
    }

    function s() {
        function t() {
            a = document.createElement("div"), document.getElementById("canvas").appendChild(a), r = new THREE.PerspectiveCamera(75, g / p, 1, 1e4), r.position.z = option_hero_background_waves_distance, s = new THREE.Scene, h = new Array;
            for (var t = 2 * Math.PI, n = new THREE.SpriteCanvasMaterial({
                ...
                for (var m = 0; _ > m; m++) l = h[i++] = new THREE.Sprite(n), l.position.x = f * u - d * u / 2, l.position.z = m * u - _ * u / 2, s.add(l);
            c = new THREE.CanvasRenderer, c.setPixelRatio(window.devicePixelRatio), c.setSize(g, p), a.appendChild(c.domElement), c.setClearColor(option_hero_background_waves_background_color), document.addEventListener("mousemove", o, !1), window.addEventListener("resize", e, !1)
        }

        function e() {
            var t = $(".hero .level-1").width(),
                e = $(".hero .level-1").height();
            b = t / 2, y = e / 2, r.aspect = t / e, r.updateProjectionMatrix(), c.setSize(t, e)
        }

        function o(t) {
            m = t.clientX - b, v = t.clientY - y
        }
        ...
        function i() {
            if (w) {
                r.position.x += .05 * (m - r.position.x), r.position.y += .05 * (-v - r.position.y), r.lookAt(s.position);
                for (var t = 0, e = 0; d > e; e++)
                    for (var o = 0; _ > o; o++) l = h[t++], l.position.y = 50 * Math.sin(.3 * (e + f)) + 50 * Math.sin(.5 * (o + f)), l.scale.x = l.scale.y = 4 * (Math.sin(.3 * (e + f)) + 1) + 4 * (Math.sin(.5 * (o + f)) + 1);
                c.render(s, r), f += .1
            }
        }
        $(".hero .background-content .bg-overlay").css("z-index", "2");
        var a, r, s, c, h, l, u = option_hero_background_waves_dotSpacing,
            d = option_hero_background_waves_dotAmountX,
            _ = option_hero_background_waves_dotAmountY,
            g = $(".hero .level-1").width(),
            p = $(".hero .level-1").height(),
            f = 0,
            m = 0,
            v = 0,
            b = g / 2,
    ...
    function c() {
        ...
        function n() {
            l = document.createElement("canvas"), u = l.getContext("2d"), b = {
                x: 0,
                y: 0
            }, S = [], g = 180, p = .25 * g, document.getElementById("canvas").appendChild(l), i(), c()
        }

        function i() {
            d = $(".hero .level-1").width(), _ = $(".hero .level-1").height(), l.width = d, l.height = _, b.x = d / 2, b.y = _ / 2, y = !1, w = 0, x = 0, S.length = 0, k = 0, a(), u.strokeStyle = option_hero_background_mesh_color, u.lineWidth = 2
        }

        function a() {
            for (var o = -g / 2; d + g > o; o += g) {
                w++;
                for (var n = -g / 2; _ + g > n; n += g) o == -g / 2 && x++, S.push(new t({
                    x: ~~(o + e(-p, p)),
                    y: ~~(n + e(-p, p))
                }))
            }
        ...
        function r() {
            y || (b.x = d / 2 + 90 * Math.cos(k / 40), b.y = _ / 2 + 90 * Math.sin(k / 40)), S.forEach(function(t) {
                t.step()
            }), k++
        }
        ...
        function s() {
            ...
            for (var t = 0; w > t; t++)
                for (var e = 0; x > e; e++) f = S[t * x + e], m = t === w - 1 ? null : S[(t + 1) * x + e], v = e === x - 1 ? null : S[t * x + e + 1], m && (u.moveTo(f.x, f.y), u.lineTo(m.x, m.y)), v && (u.moveTo(f.x, f.y), u.lineTo(v.x, v.y));
        ...
        function c() {
            requestAnimationFrame(c), r(), s()
        }

        function h(t) {
            y = !0, b.x = t.pageX, b.y = t.pageY
        }
        var l, u, d, _, g, p, f, m, v, b, y, w, x, S, k;
        ...
        }, window.addEventListener("resize", i), window.addEventListener("mousemove", h), n(), $(".hero .background-content #canvas canvas").css("background-color", option_hero_background_mesh_background_color)
    }
        ...
        ! function(t, e, o, n) {
            ...
            ! function() {
                ...
                init: function() {
                    ...
                    var a = function() {
                        r.w = r.$el.width(), r.h = r.$el.height(), r.initW = r.w, r.initH = r.h, r.portrait = r.w < r.h, r.wrapper = t("<canvas />").addClass(r.settings.divclass), r.wrapper.appendTo(r.el), r.starz = t("canvas", r.el), r.starz[0].getContext && (r.context = r.starz[0].getContext("2d"), h = !0), r.context.canvas.width = r.w, r.context.canvas.height = r.h
                    };
                    a();
                    var s = function() {
                        if (h) {
                ...
                start: function() {
                    return c || (c = !0, this.init()), i || (i = !0, this.loop()), e.addEventListener("resize", function() {
                        r.resizer()
    ...
    function l() {
        function t() {
            e(), n(), i(), a(), l(), r(T.offsetWidth, T.offsetHeight), s()
        }

        function e() {
            v = new FSS.CanvasRenderer, o(x.renderer)
        }

        function o(t) {
            _ && C.removeChild(_.element), _ = v, _.setSize(T.offsetWidth, T.offsetHeight), C.appendChild(_.element)
        }
        ...
        function i() {
            g.remove(p), _.clear(), f = new FSS.Plane(y.width * _.width, y.height * _.height, y.segments, y.slices), m = new FSS.Material(y.ambient, y.diffuse), p = new FSS.Mesh(f, m), g.add(p);
            var t, e;
        ...
        function a() {
            var t, e;
            for (t = g.lights.length - 1; t >= 0; t--) e = g.lights[t], g.remove(e);
            for (_.clear(), t = 0; t < w.count; t++) e = new FSS.Light(w.ambient, w.diffuse), e.ambientHex = e.ambient.format(), e.diffuseHex = e.diffuse.format(), g.add(e), e.mass = Math.randomInRange(.5, 1), e.velocity = FSS.Vector3.create(), e.acceleration = FSS.Vector3.create(), e.force = FSS.Vector3.create(), e.ring = document.createElementNS(FSS.SVGNS, "circle"), e.ring.setAttributeNS(null, "stroke", e.ambientHex), e.ring.setAttributeNS(null, "stroke-width", "0.5"), e.ring.setAttributeNS(null, "fill", "none"), e.ring.setAttributeNS(null, "r", "10"), e.core = document.createElementNS(FSS.SVGNS, "circle"), e.core.setAttributeNS(null, "fill", e.diffuseHex), e.core.setAttributeNS(null, "r", "4")
        }

        function r(t, e) {
            _.setSize(t, e), FSS.Vector3.set(k, _.halfWidth, _.halfHeight), i()
        }

        function s() {
            d = Date.now() - S, c(), h(), requestAnimationFrame(s)
        }

        function c() {
            var t, e, o, n, i, a, r, s = y.depth / 2;
            for (FSS.Vector3.copy(w.bounds, k), FSS.Vector3.multiplyScalar(w.bounds, w.xyScalar), FSS.Vector3.setZ(M, w.zOffset), w.autopilot && (t = Math.sin(w.step[0] * d * w.speed), e = Math.cos(w.step[1] * d * w.speed), FSS.Vector3.set(M, w.bounds[0] * t, w.bounds[1] * e, w.zOffset)), n = g.lights.length - 1; n >= 0; n--) {
                i = g.lights[n], FSS.Vector3.setZ(i.position, w.zOffset);
                var c = Math.clamp(FSS.Vector3.distanceSquared(i.position, M), w.minDistance, w.maxDistance),
                    h = w.gravity * i.mass / c;
                FSS.Vector3.subtractVectors(i.force, M, i.position), FSS.Vector3.normalise(i.force), FSS.Vector3.multiplyScalar(i.force, h), FSS.Vector3.set(i.acceleration), FSS.Vector3.add(i.acceleration, i.force), FSS.Vector3.add(i.velocity, i.acceleration), FSS.Vector3.multiplyScalar(i.velocity, w.dampening), FSS.Vector3.limit(i.velocity, w.minLimit, w.maxLimit), FSS.Vector3.add(i.position, i.velocity)
            }
        ...
        function h() {
            if (_.render(g), w.draw) {
                var t, e, o, n;
                for (t = g.lights.length - 1; t >= 0; t--) n = g.lights[t], e = n.position[0], o = n.position[1], _.context.lineWidth = .5, _.context.beginPath(), _.context.arc(e, o, 10, 0, Math.PIM2), _.context.strokeStyle = n.ambientHex, _.context.stroke(), _.context.beginPath(), _.context.arc(e, o, 4, 0, Math.PIM2), _.context.fillStyle = n.diffuseHex, _.context.fill()
            }
        }
        ...
        function u(t) {
            r(T.offsetWidth, T.offsetHeight), h()
        }
        $(".hero .bg-pattern").remove(), $(".hero .bg-overlay").remove();
        var d, _, g, p, f, m, v, b = setInterval(function() {
        ...
        if (t(), canvas.getContext) {
            ...
            setInterval(function() {
                for (var t = 1; 1e3 >= t; t++) P.beginPath(), E ? (P.moveTo(0, randomize(canvas.height + 10)), E = !1) : (P.moveTo(randomize(canvas.width + 10), 0), E = !0), P.lineTo(randomize(canvas.width + 50), randomize(canvas.height + 50)), P.lineTo(randomize(canvas.width + 50), randomize(canvas.height + 50)), P.fillStyle = getRndColor(), P.fill()
            }, 5e3)
        }
    }
    ...
    function d() {
        "on" === option_hero_gravity_effect && _()
    }
        ...
        function t(t, e) {
            ...
            o.prototype = {
                ...
                line: function() {
                    ...
                    for (o = 0; i > o; o++)
                        for (n = 0; i > n; n++) t = u.stars[o], e = u.stars[n], t.x - e.x < u.distance && t.y - e.y < u.distance && t.x - e.x > -u.distance && t.y - e.y > -u.distance && t.x - u.position.x < u.radius && t.y - u.position.y < u.radius && t.x - u.position.x > -u.radius && t.y - u.position.y > -u.radius && (h.beginPath(), h.moveTo(t.x, t.y), h.lineTo(e.x, e.y), h.stroke(), h.closePath())
                }
            }, this.createStars = function() {
                var e, n, i = u.length;
                for (h.clearRect(0, 0, t.width, t.height), n = 0; i > n; n++) u.stars.push(new o), e = u.stars[n], e.create();
                e.line(), e.animate(), u.stars.splice(i, i)
            }, this.setCanvas = function() {
                t.width = u.width, t.height = u.height, h.fillStyle = u.star.color, h.strokeStyle = u.line.color, h.lineWidth = u.line.width, e && e.hasOwnProperty("position") || (u.position = {
                    x: .5 * t.width,
                    y: .5 * t.height
                })
                ...
                $(window).on("mousemove", function(t) {
                    u.position.x = t.pageX - c.offset().left, u.position.y = t.pageY - c.offset().top
                })
            }, this.init = function() {
    ...
    if ("on" == option_hero_animate_content_on_scroll) {
        ...
        $(window).scroll(function() {
            var t = $(window).scrollTop(),
                e = 1 - t / g * 2.8;
            g > t && ($(".front-content").css("margin-top", t), $(".front-content").css("opacity", e))
        })
    }
    ...
    if ("on" == option_hero_3d_hover_effect) {
        ...
        $(".hero").on("mousemove", function(t) {
            var e = $(window).innerWidth(),
                ...
                i = -(e / 2 - t.pageX) / n,
                a = -(o / 2 - t.pageY) / n * 0;
            f.attr("style", "transform: rotateY(" + i + "deg) rotateX(" + a + "deg);-webkit-transform: rotateY(" + i + "deg) rotateX(" + a + "deg);-moz-transform: rotateY(" + i + "deg) rotateX(" + a + "deg)")
        })
    }
    var v = 800,
        b = 6e3;
    "slider" === option_hero_background_mode && (v = option_hero_background_slider_transitionDuration, b = option_hero_background_slider_delay), "kenburns" === option_hero_background_mode && (v = option_hero_background_kenburns_transitionDuration, b = option_hero_background_kenburns_delay), $("#cycle").cycle({
        fx: "scrollVert",
        timeout: b,
        delay: 0,
...
$(document).ready(function() {
    ...
    $(".work-grid").cubeportfolio({
        ...
        e.preventDefault();
        for (var t = $(this).serializeArray(), a = t.length, s = 0; a > s; s++) "true" == $("#contact-form input[name='" + t[s].name + "']").attr("data-require-filling") ? t.push({
            name: t[s].name + "_required",
            value: !0
        }) : t.push({
            name: t[s].name + "_required",
            value: !1
        ...
        $.ajax({
            ...
            success: function(e) {
                $("#contact-form .form-group").removeClass("error"), setTimeout(function() {
                    "" !== e.nameMessage && $("#contact-form-name").parent().addClass("error"), "" !== e.emailMessage && $("#contact-form-email").parent().addClass("error"), "" !== e.companyMessage && $("#contact-form-company").parent().addClass("error"), "" !== e.phoneMessage && $("#contact-form-phone").parent().addClass("error"), "" !== e.addressMessage && $("#contact-form-address").parent().addClass("error"), "" !== e.subjectMessage && $("#contact-form-subject").parent().addClass("error"), "" !== e.messageMessage && $("#contact-form-message").parent().addClass("error")
                }, 25), "" !== e.succesMessage && ($("#contact-form").addClass("success"), $("#contact-form button span").removeClass("ti-arrow-right").addClass("ti-check"), $("#contact-form input").attr("placeholder", ""), $("#contact-form-message").attr("placeholder", e.succesMessage), $("#contact-form input,#contact-form button").val("").prop("disabled", !0))
            }
        })
    ...
    "" != option_google_maps_api_key && "AIzaSyBibXe8KqGeC6orbxHN_32X2drJUN8WokWXE" != option_google_maps_api_key && (t = t + "?key=" + option_google_maps_api_key), loadScript(t, function() {
        function e() {
            function e() {
            ...
            if ($("#map").length) var r = new google.maps.Map(n, i);
            var p = {
        ...
        if (0 != $("#map").length) {
            var t = new google.maps.LatLng(option_google_maps_coordinates[0], option_google_maps_coordinates[1]),
                a = 14,
                s = $(".block-contact-1 .tab-content .map-wrapper .button-description .content-visible").css("background-color"),
                o = 12,
                l = 1;
